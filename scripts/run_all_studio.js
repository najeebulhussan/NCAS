...
async function masterRun() {
  ...
  // Step 6: Multi-Voice AI Avatar Voiceover Engine (English & Urdu TTS)
  runStep(6, "Multi-Voice AI Avatar Voiceover Engine (TTS)", "node scripts/generate_voiceover.js --lang ur");
